...
# Always load simulation engine (no external C-dependencies)
from simulation.engine import run_simulation

# Import route modules (defensively loaded if statsmodels C-extensions fail)
try:
    ...
    print(f"[WARN] Real ML model imports skipped (using mock fallback): {_e}")
    get_forecast = None
    get_attribution = None
    get_enforcement_priorities = None
...
def simulation_run(payload: dict):
